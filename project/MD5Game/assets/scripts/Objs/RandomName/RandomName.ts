...
export class RandomName {
    ...
    constructor() {
      ...
      "音响"
        ...
        this.femaleNameItems = "嘉、琼、桂、娣、叶、...".split("、");
        this.maleNameItems = "涛、昌、进、林、有、...".split("、");
        this.familyNameItemsSin = "赵,钱,孙,李,周,吴,...".split(",");
        this.familyNameItemsSur = "辕轩,令狐,钟离,宇文,...".split(",");
    ...
    getFamilyName(sur: boolean = true): string {
        if (sur) {
